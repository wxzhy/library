...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  books: () => import("@/views/books/index.vue"),
  borrows: () => import("@/views/borrows/index.vue"),
  ...
  manage_book: () => import("@/views/manage/book/index.vue"),
  manage_borrow: () => import("@/views/manage/borrow/index.vue"),
