...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    name: 'books',
    path: '/books',
    component: 'layout.base$view.books',
    meta: {
      title: 'books',
      i18nKey: 'route.books',
      order: 4,
  ...
  },
  {
    name: 'borrows',
    path: '/borrows',
    component: 'layout.base$view.borrows',
    meta: {
      title: 'borrows',
      i18nKey: 'route.borrows',
      order: 5,
    ...
    children: [
      {
        name: 'manage_book',
        path: '/manage/book',
        component: 'view.manage_book',
        meta: {
          title: 'manage_book',
          icon: 'mdi:book-edit-outline',
          order: 2,
          i18nKey: 'route.manage_book'
        }
      },
      {
        name: 'manage_borrow',
        path: '/manage/borrow',
        component: 'view.manage_borrow',
        meta: {
          title: 'manage_borrow',
          icon: 'mdi:book-check',
          order: 4,
          i18nKey: 'route.manage_borrow'
        }
      },
      {
        name: 'manage_menu',
